...
const formData: FormDataExample = {
	email: "",
	title: "",
	text: "",
	checkbox: false,
...
// 4) Если на предыдущем этапе true, то запускается функция checkFormData с этим объектом
 ...
 function validateFormData(data: FormDataExample): boolean {
...
function checkFormData(data: FormDataExample) {
	const { email } = data;
	const emails: string[] = ["example@gmail.com", "example@ex.com", "admin@gmail.com"];
  const findEmail: boolean = emails.some((e) => e === email)
